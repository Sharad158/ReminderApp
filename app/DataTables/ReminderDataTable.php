...
class ReminderDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', function ($user) {
            $id = $user->reminder_notification_id;

            $edit = '<a class="label label-success badge badge-light-success" href="' . route('reminders.edit',$id) . '"  title="Update"><i class="fa fa-edit"></i>&nbsp</a>';
            ...
            $view = '<a class="label label-primary badge badge-light-primary" href="'. route('reminders.show',$id).'"  title="View"><i class="fa fa-eye"></i>&nbsp</a>';
        ...
        ->editColumn('schedule_time', function($user) {
            return GlobalHelper::getFormattedDate($user->schedule_time);
        })
        ->editColumn('created_at', function($user) {
            return GlobalHelper::getFormattedDate($user->created_at);
        })

        ->rawColumns(['description','created_at','schedule_time','status','action']);//->toJson();
    }
    /**
