...
$profile_image_url = $profile_picture == '' ? '/resources/assets/admin/dist/img/user-placeholder.jpg' : $profile_picture;
?>
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                    ...
                    <span class="avatar">
                        <img class="round" src="{{ URL::asset($profile_image_url) }}" alt="avatar" height="40"
                            width="40">
